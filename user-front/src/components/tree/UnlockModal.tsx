...
export function UnlockModal({
  ...
  return (
    ...
    >
      <div
        className="bg-neutral-100 text-black px-12 py-10 w-[460px] max-w-[90vw] font-pixel"
      ...
      >
        ...
        <div className="border border-black px-4 py-3 flex flex-col gap-3 items-start text-lg">
          <button
