...
// RP 충전 안내 문구 — 결제 화살표 1차 클릭 시 노출(이용 안내). 우측 버튼 = 안내 동의 간주.
export const RP_GUIDE: string[] = [
  "RP는 사이트 내부 콘텐츠 열람 전용 포인트이며, 현금 환전 및 계정 간 이전은 불가합니다.",
  "미사용 RP는 환불 요청이 가능하나, RP를 사용하여 노드 또는 콘텐츠 열람이 시작된 경우 해당 사용분은 환불이 제한될 수 있습니다.",
  "우측 버튼을 누르면 위 안내사항 및 RP 이용정책에 동의한 것으로 간주됩니다.",
];
